...
export default function Nav(){
  return React.createElement('nav',{style:{display:'flex',alignItems:'center',gap:'1.5rem',padding:'1rem 2rem',borderBottom:'1px solid #1e293b',background:'#0d1117',flexWrap:'wrap'}},
    ...
    React.createElement('a',{href:'/',style:{color:'#94a3b8',textDecoration:'none',fontSize:'0.9rem'}},'Chat'),React.createElement('a',{href:'/history',style:{color:'#94a3b8',textDecoration:'none',fontSize:'0.9rem'}},'History'),React.createElement('a',{href:'/api-keys',style:{color:'#94a3b8',textDecoration:'none',fontSize:'0.9rem'}},'API Keys'),React.createElement('a',{href:'/settings',style:{color:'#94a3b8',textDecoration:'none',fontSize:'0.9rem'}},'Settings')
  );
}